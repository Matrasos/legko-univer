...
<head>
  ...
  <title> Интегрируем digital решения | LEGKO </title>

  <meta property="og:locale" content="ru_KZ">
  <meta property="og:title" content="Интегрируем digital решения">
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://legko.company">
  <meta property="og:site_name" content="LEGKO | Интегрируем digital решения">
  <meta property="og:image" content="/assets/favicon/open_graph_img.png">

  <meta property="og:description"
    content="Мы предлагаем услуги по разработке веб продуктов (сайты, автоматизация задач в интернете, визитки, работа с метриками и т.д), их внедрению в бизнес и продвижению в поисковых системах.">

  <meta name="description"
    content="Мы предлагаем услуги по разработке веб продуктов (сайты, автоматизация задач в интернете, визитки, работа с метриками и т.д), их внедрению в бизнес и продвижению в поисковых системах.">

  <meta name="keywords"
    content="Веб-разработка, профессиональные услуги, креативные решения, digital, интеграция, эффективность, уникальный характер, веб-проекты, креативные и инновационные решения, разработка на высоком уровне, цифровые технологии, пользовательский опыт, удобство использования, технологический прогресс.">
    ...
    <main class="main">
      ...
      <section class="wow fadeInUp services special">
        ...
        <div class="services__grid">
          ...
          <a href="<?= $service["link"] ?>" class="services__grid-card">
