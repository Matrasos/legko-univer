...
<head>
  ...
  <title> Wir integrieren digitale Lösungen. | LEGKO </title>

  <meta property="og:locale" content="de_KZ">
  <meta property="og:title" content="Wir integrieren digitale Lösungen.">
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://legko.company">
  <meta property="og:site_name" content="LEGKO | Wir integrieren digitale Lösungen.">
  <meta property="og:image" content="/assets/favicon/open_graph_img_de.png">

  <meta property="og:description"
    content="Wir bieten Dienstleistungen für die Entwicklung von Webprodukten (Websites, Automatisierung von Aufgaben im Internet, Visitenkarten, Arbeit mit Metriken usw.), ihre Implementierung im Geschäftsbereich und ihre Promotion in Suchmaschinen an.">

  <meta name="description"
    content="Wir bieten Dienstleistungen für die Entwicklung von Webprodukten (Websites, Automatisierung von Aufgaben im Internet, Visitenkarten, Arbeit mit Metriken usw.), ihre Implementierung im Geschäftsbereich und ihre Förderung in Suchmaschinen an.">

  <meta name="keywords"
    content="Web-Entwicklung, professionelle Dienstleistungen, kreative Lösungen, digital, Integration, Effizienz, einzigartiger Charakter, Webprojekte, kreative und innovative Lösungen, Entwicklung auf höchstem Niveau, digitale Technologien, Benutzererfahrung, Benutzerfreundlichkeit, technologischer Fortschritt.">
    ...
    <main class="main">
      ...
      <section class="wow fadeInUp services special">
        ...
        <div class="services__grid">
          ...
          <a href="<?= $service["link"] ?>/de" class="services__grid-card">
