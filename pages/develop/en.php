...
<head>
  ...
  <meta property="og:site_name"
    content="LEGKO | we turn your idea into reality by selecting the best implementation technology">
  <meta property="og:image" content="/assets/favicon/open_graph_img_eng.png">


  <meta property="og:description"
    content="Learn how our developers create high-quality and innovative web designs with a focus on functionality and user experience. We develop web solutions that combine creative design, technological expertise and ease of use.">
  ...
  <meta name="keywords"
    content="Development, web development, web projects, programming, developers, web applications, user experience, creative design, innovation, functionality, technological expertise, responsive design, cross-platform development, front-end development, back-end development, custom development, MVP development, testing, performance optimization, Agile development, technical support, development cycle.">
