...
<head>
  ...
  <link rel="alternate" hreflang="de-KZ" href="https://legko.company/develop/de">
  ...
  <meta property="og:site_name"
    content="LEGKO | Wir verwandeln Ihre Idee in Realität, indem wir die beste Umsetzungstechnologie auswählen.">
  <meta property="og:image" content="/assets/favicon/open_graph_img_de.png">


  <meta property="og:description"
    content="Erfahren Sie, wie unsere Entwickler hochwertige und innovative Webprojekte erstellen, indem sie besonderes Augenmerk auf Funktionalität und Benutzererfahrung legen. Wir entwickeln Web-Lösungen, die kreatives Design, technologische Expertise und Benutzerfreundlichkeit kombinieren.">
  ...
  <meta name="keywords"
    content="Entwicklung, Webentwicklung, Webprojekte, Programmierung, Entwickler, Webanwendungen, Benutzererfahrung, kreatives Design, Innovationen, Funktionalität, technologische Expertise, responsives Design, plattformübergreifende Entwicklung, Frontend-Entwicklung, Backend-Entwicklung, individuelle Entwicklung, MVP-Entwicklung, Testing, Leistungsoptimierung, Agile Entwicklung, technischer Support, Entwicklungszyklus.">
