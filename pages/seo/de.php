...
$texts = [
  'title' => 'SEO/Контекст',
  'subtitle' => 'знакомим  клиента с вашим продуктом на этапе запроса',
];

$plan = [
  'plan-title' => 'Ведем всю seo оптимизацию по отработаному механизму',
  ['01', '02', '03', '04', '05', '06'],
  [
    'Проводим аудит',
    'Изучаем ЦА',
...
$advantages = [
  'title' => 'Что дает SEO?',
  'subtitle' => 'SEO (Search Engine Optimization) играет важную роль в современном бизнесе и является неотъемлемой частью успешной онлайн стратегии.',
  [
    '+30%',
    '+70%',
    '-40%',
  ...
  [
    'дешевого <br> трафика',
    'к узнаваемости <br> в поисковиках',
    'цены <br> рекламы',
    'к отслеживанию <br> метрик',
  ]
];
$cards = [
  'title' => 'Где вы увидите SEO?',
  'subtitle' => 'Его видно при детальном рассмотрении сайта',
  [
    'Позиция в поисковиках',
    'Органический трафик',
    'Внутренняя оптимизация',
    'Аналитика',
  ],
  [
    'Проверьте рейтинг вашего сайта в результатах поиска по ключевым запросам. <br> <br> Если ваш сайт появляется в верхних результатах или на первой странице, это может быть признаком хорошей оптимизации.',
    'Анализируйте объем органического трафика на вашем сайте. <br> <br> Если вы видите стабильный рост посещений из поисковых систем, это может указывать на хорошую SEO-оптимизацию.',
    'Проверьте структуру вашего сайта, использование заголовков, мета-тегов, альтернативных текстов для изображений и других SEO-элементов. <br> <br> Хорошо оптимизированный сайт должен иметь правильную структуру и использовать ключевые слова в соответствующих местах.',
    'Используйте инструменты аналитики, такие как Google Analytics, чтобы отслеживать показатели производительности вашего сайта, такие как отказы, время нахождения на сайте и конверсии. <br> <br> Эти данные помогут вам оценить эффективность вашей SEO-оптимизации.',
  ],
  'icons' => [
    '
  ...
  'addition' => '* и это только малая часть приемуществ SEO'
];
$technologies = [
...
<head>
  ...
  <link rel="alternate" hreflang="de-KZ" href="https://legko.company/seo/de">

  <meta name="author" content="legko.company">
  <meta name="referrer" content="always">
  <link href="https://legko.company" rel="canonical">

  <title> SEO/Context | LEGKO </title>

  <meta property="og:locale" content="de_KZ">
  <meta property="og:title" content="SEO/Context">
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://legko.company/seo">
  <meta property="og:site_name"
    content="LEGKO | Wir stellen Ihrem Kunden den erforderlichen Service vor dem Klicken auf den Link vor.">
  <meta property="og:image" content="/assets/favicon/open_graph_img_de.png">


  <meta property="og:description"
    content="Erfahren Sie, wie unsere SEO-Experten wirksame Suchmaschinenoptimierungsstrategien entwickeln, um die Sichtbarkeit Ihrer Website in Suchmaschinen zu verbessern. Wir entwickeln SEO-Strategien, die dazu beitragen, dass Ihre Website in den Suchergebnissen weit oben rangiert und mehr organischen Traffic anzieht.">

  <meta name="description"
    content="Erfahren Sie, wie unsere SEO-Experten effektive Suchmaschinenoptimierungsstrategien entwickeln, um die Sichtbarkeit Ihrer Website in Suchmaschinen zu verbessern. Wir entwickeln SEO-Strategien, die dazu beitragen, dass Ihre Website in den Suchergebnissen weit oben rangiert und mehr organischen Traffic anzieht.">

  <meta name="keywords"
    content="SEO, Suchmaschinenoptimierung, SEO-Strategie, Website-Optimierung, Sichtbarkeitsverbesserung, Organischer Traffic, SEO-Experten, Schlüsselwörter, Wettbewerbsanalyse, On-Page-Optimierung, Technische SEO, Inhaltsoptimierung, Lokale SEO, Mobile Optimierung, SEO-Audit, Rankings steigern, Backlinks, Optimierung der Ladezeit, Optimierung der Benutzererfahrung, SEO-Wachstumsstrategie, Suchsichtbarkeit, SEO-Beratung, Organische Ergebnisse.">
        ...
        <div class="plan__description">
          ...
          for ($i = 0; $i < count($numbers); $i++) {
            ...
            <div class="wow fadeInUp ">
              <p>' . $numbers[$i] . '</p>
              <h3 data-i18n="seo-plan-item-' . ($i + 1) . '">' . $text[$i] . '</h3>
            </div>
            ';
          }
          ?>
      ...
      <section class="advantages">
        ...
        <div class="advantages__grid">
          ...
          for ($i = 0; $i < count($numbers); $i++) {
            ...
            echo '<p>' . $numbers[$i] . '</p>';
            echo '<p data-i18n="seo-advantages-item-' . ($i + 1) . '">' . $text[$i] . '</p>';
            echo '</div>';
          }
          ?>
        </div>
      ...
      <section class="cards">
        ...
        <div class="cards__grid">
          ...
          for ($i = 0; $i < count($title); $i++) {
            ...
            echo $icons[$i];
            echo '<h2 data-i18n="seo-cards-item-title-' . ($i + 1) . '">' . $title[$i] . '</h2>';
            echo '<p data-i18n="seo-cards-item-text-' . ($i + 1) . '">' . $text[$i] . '</p>';
            echo '</div>';
          }
          ?>
        </div>
      ...
      <section class="technologies">
        ...
        <div class="wow fadeInUp technologies__list">
          <?php foreach ($technologies[0] as $i => $technology): ?>
            <div data-i18n="seo-technologies-item-<?php echo ($i + 1); ?>">
              <?php echo $technology; ?>
            </div>
          <?php endforeach; ?>
        </div>
